        ...
        <nav class="bg-white-50 flex justify-between lg:justify-start items-center"
            ...
            <div class="links lg:block hidden w-1/6 md:w-4/6">
                <ul class="menu flex items-center justify-center gap-5">
                    <li><a @click="$router.push('/dashboard')" class="botones-link">Tablero</a></li>
                    <li><a @click="$router.push('/adminRequest')" class="botones-link">Solicitudes</a></li>
                    <li><a @click="$router.push('/generateCSV')" class="botones-link">Generar CSV</a></li>
                    <li><a @click="$router.push('/helpAdmin')" class="botones-link">Ayuda</a></li>
