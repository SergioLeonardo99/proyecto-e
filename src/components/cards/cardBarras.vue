<template>
  ...
  <div class="flex flex-col justify-center h-full">
    <body class="bg-gray-100 text-gray-900 tracking-wider relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-blueGray-700 leading-normal">
              ...
              <div  class="p-10 mt-6 lg:mt-0 rounded shadow bg-white">
                <div class="overflow-x-auto p-3">
                  <header class="px-5 py-4 border-b border-gray-100">
                    <div class="letra   text-4xl flex space-x-1 items-center text-center letra leading-tight text-teal-700 ">Estadística  áreas de la empresa </div>
