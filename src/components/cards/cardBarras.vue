<template>
  ...
  <div class="flex flex-col justify-center h-full">
    ...
    <body
      ...
      <div class="container w-full md:w-1/1 xl:w-6/20  mx-auto px-2 ">
            ...
            <div class="p-10 mt-6 lg:mt-0 rounded shadow bg-white">
              <div class="overflow-x-auto p-3">
                <header class="px-5 py-4 border-b border-gray-100">
                  <div
                    class="letra   text-4xl flex space-x-1 items-center text-center letra leading-tight text-teal-700 ">
                ...
                <div class="container mx-auto px-0 flex lg:max-w-full  justify-center  ">
                  <div class="items-center flex flex-wrap ">
                    <div class="w-full md:w-6/12 lg:max-h-72  mb-18  xl:max-h-52/max-w-xs  ">
                    ...
                    <div v-if="tipoGrafico == 'Nivel General'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          Nivel evaluado en la encuesta con 5 áreas clave para su empresa, Conocimiento general de la
                          empresa,
                          Infraestructura tecnológica, Madurez de los procesos, relaciones con los clientes y relaciones
                          con los
                          proveedores.
                        </p>
                    ...
                    <div v-if="tipoGrafico == 'Nivel Conocimiento'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <h3 class="text-3xl font-semibold">Nivel conocimiento general comparado con otras empresas del
                          sector:</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          El conocimiento general de la empresa se enfoca en resaltar los aspectos generales de la
                          empresa,
                          enfocándose en determinar su estado con respecto a las otras empresas, para así generar una
                          base solida en
                    ...
                    <div v-if="tipoGrafico == 'Nivel Infraestructura'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <h3 class="text-3xl font-semibold">Nivel Infraestructura Tecnológica comparado con otras
                          empresas del
                          sector:</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          La infraestructura tecnológica permite evidenciar en que nivel se encuentra la empresa con
                          respecto a el
                          software que utilice para mejorar sus procesos internos, de igual manera en este nivel se
                          evalúan los
                    ...
                    <div v-if="tipoGrafico == 'Nivel Madurez'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <h3 class="text-3xl font-semibold">Nivel Madurez de procesos comparado con otras empresas del
                          sector:</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          La madurez de procesos busca determinar el nivel de implementación documental de la empresa,
                          las
                    ...
                    <div v-if="tipoGrafico == 'Nivel Clientes'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <h3 class="text-3xl font-semibold">Nivel Relaciones con los clientes comparado con otras
                          empresas del
                          sector:</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          Las relaciones con los clientes buscan evaluar la cantidad de clientes, los formatos que
                          utilizan para el
                          intercambio de información y la percepción de las empresas al momento de interactuar con los
                          clientes.
                        </p>
                    ...
                    <div v-if="tipoGrafico == 'Nivel Proveedores'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <h3 class="text-3xl font-semibold">Nivel relaciones con los proveedores comparado con otras
                          empresas del
                          sector:</h3>
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          Las relaciones con los proveedores buscan evaluar la cantidad de proveedores, los formatos que
                          utilizan
                          para el intercambio de información junto con el tiempo respectivo en el que se utilizan
                          finalmente se mide
                    ...
                    <div v-if="tipoGrafico == 'Nivel Total'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
                      <div class="md:pr-12">
                        ...
                        <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                          Evalúa en conjunto los 5 niveles anteriores, para sumar un ponderado y realizar una
                          comparación con
