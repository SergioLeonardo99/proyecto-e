<template>
    ...
    <div class="">
        ...
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{nombreEmpresa}}</div>
        <p class="text-gray-600 text-sm text-center">Nombre de la organización</p>
        </div> 
       
        <div class="flex flex-col">
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{nitEmpresa}}</div>
        <p class="text-gray-600 text-sm text-center">Nit de la empresa</p>
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{email}}</div>
        <p class="text-gray-600 text-sm text-center">Correo de la empresa</p>
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{direccion}}</div>
        <p class="text-gray-600 text-sm text-center">Dirección de la empresa</p>
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{telefonoEmpresa}}</div>
        <p class="text-gray-600 text-sm text-center">Telefono</p>
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{encargado}}</div>
        <p class="text-gray-600 text-sm text-center">Encargado</p>
        <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer"> {{cargoEncargado}}</div>
        ...
        <div class="flex flex-row justify-center font-semibold mx-auto my-4">
            ...
            <button @click="$router.push('/editprofile')" type="button" class="bg-grey-light hover:bg-grey text-grey-darkest font-bold inline-flex items-center my-auto text-gray-800 py-1 px-4 border-2 border-cyan-600 hover:bg-cyan-600 hover:cursor-pointer hover:text-white rounded-3xl mx-2">
