        ...
        '41': empresaPuntos[41], 
            ...
            <div v-if="tipoGrafico=='Nivel General'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Nivel evaluado en la encuesta con 5 áreas clave para su empresa, Conocimiento general de la empresa, Infraestructura tecnológica, Madurez de los procesos, relaciones con los clientes y relaciones con los proveedores.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Conocimiento'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  El conocimiento general de la empresa se enfoca en resaltar los aspectos generales de la empresa, enfocándose en determinar su estado con respecto a las otras empresas, para así generar una base solida en la cual se puede trabajar para seguir con el ciclo de mejora continua.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Infraestructura'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Nivel Infraestructura Tecnológica comparado con otras empresas del sector:</h3>
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  La infraestructura tecnológica permite evidenciar en que nivel se encuentra la empresa con respecto a el software que utilice para mejorar sus procesos internos, de igual manera en este nivel se evalúan los diferentes tipos de maquinaria que se utilicen.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Madurez'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  La madurez de procesos busca determinar el nivel de implementación documental de la empresa, las certificaciones aplicadas a la empresa, el número de asesorías en diversos temas de interés, y finalmente su interés con respecto a las capacitaciones futuras.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Clientes'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Nivel Relaciones con los clientes comparado con otras empresas del sector:</h3>
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Las relaciones con los clientes buscan evaluar la cantidad de clientes, los formatos que utilizan para el intercambio de información y la percepción de las empresas al momento de interactuar con los clientes.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Proveedores'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <h3 class="text-3xl font-semibold">Nivel relaciones con los proveedores comparado con otras empresas del sector:</h3>
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Las relaciones con los proveedores buscan evaluar la cantidad de proveedores, los formatos que utilizan para el intercambio de información junto con el tiempo respectivo en el que se utilizan finalmente se mide la percepción de las empresas al momento de interactuar con los clientes.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Total'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Evalúa en conjunto los 5 niveles anteriores, para sumar un ponderado y realizar una comparación con respecto a otras empresas del sector.
                </p>
            ...
            <div v-if="tipoGrafico=='Nivel Preguntas'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  En el nivel con relación a las preguntas se evidencia en que preguntas se tienen mas dificultades para revisar en que aspectos puede mejorar la empresa buscando el ciclo de mejora continua.
                </p>
            ...
            <div v-if="tipoGrafico=='Complementos y cambios tecnológicos'" class="w-full md:w-5/12 ml-auto mr-auto px-4">
              <div class="md:pr-12">
                ...
                <p class="mt-4 text-lg leading-relaxed text-blueGray-500">
                  Se puede observar que palabra en el formulario presenta una mayor cantidad de frecuencia, para observar el interés general de la empresa.
                </p>
...
<div class="flex flex-row justify-center font-semibold mx-auto my-4">
        ...
        <button @click="generar()" type="button" class="bg-grey-light hover:bg-grey text-grey-darkest font-bold inline-flex items-center my-auto text-gray-800 py-1 px-4 border-2 border-cyan-600 hover:bg-cyan-600 hover:cursor-pointer hover:text-white rounded-3xl mx-2">
