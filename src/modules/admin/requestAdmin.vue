    ...
    <body class="bg-gray-100 text-gray-900 tracking-wider leading-normal">
      <div class="container w-full md:w-1/1 xl:w-4/20  mx-auto px-2">
        <header class="px-5 py-4 border-b border-gray-100">
          <div class="letra text-3xl  text-center letra leading-tight text-teal-700 ">Lista de Solicitudes</div>
                          ...
                          <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                            <div class="sm:flex sm:items-start">
                              ...
                              <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                                <DialogTitle as="h3" class="text-lg font-medium leading-6 text-gray-900">{{ msgTitulo }}
                                </DialogTitle>
                                <div v-if="atendido">
                            ...
                            <button type="button"
                              class="inline-flex w-full justify-center rounded-md border border-transparent bg-teal-700 px-4 py-2 text-base font-medium text-white shadow-sm hover:bg-teal-400 focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-offset-2 sm:ml-3 sm:w-auto sm:text-sm"
                              @click="open = false">Salir</button>
                            <button type="button" v-if="openBut"
                                class="mt-3 inline-flex w-full justify-center rounded-md border border-gray-300 bg-white px-4 py-2 text-base font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm"
                                @click="procesarSolicitud()">Responder solicitud</button>
  ...
  methods: {
    ...
    procesarSolicitud() {
      ...
      docRef.update({
        ...
        .then(() => {
          this.msgTitulo = 'Solicitud gestionada con exito'
          this.atendido = false
          this.openBut =false
