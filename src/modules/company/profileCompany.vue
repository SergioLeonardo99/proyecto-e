<template>
    ...
    <div class=" mx-auto my-20 rounded-md overflow-hidden  lg:max-w-full 2xl:max-w-full"
        v-if="imagenDescargada != null">
        ...
        <div class="px-6 py-4">
            ...
            <div class="flex flex-col">
                ...
                <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer">
                    {{ telefonoEmpresa }}</div>
                <p class="text-gray-600 text-sm text-center">Teléfono</p>
                <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer">
                    {{ encargado }}</div>
                <p class="text-gray-600 text-sm text-center">Encargado</p>
                <div class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer">
                    {{ cargoEncargado }}</div>
                <p class="text-gray-600 text-sm text-center">Cargo del representante</p>
            </div>
            <div class="flex flex-row justify-center font-semibold mx-auto my-4">

                <button @click="$router.push('/editCompany')" type="button"
            ...
            <p class="font-bold text-xl text-center text-gray-800 hover:text-cyan-600 hover:cursor-pointer">Acerca de la
                empresa</p>
            <br>
